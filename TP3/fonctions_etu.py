...
def selection_population(population, objectifs) :
    ...
    while not termine :
        ...
        population_triee, objectifs_tries, dominant = analyse_dominance(pop_trv, obj_trv)
        ...
        if len(selection_pop[0]) + len(id_dominant[0]) <= taille_selection :
            ...
            idx_sel = np.random.choice(id_dominant[0], taille_selection - len(x_sel), replace = False)
